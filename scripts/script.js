...
class Progress {
    ...
    register() {
        this.element.addEventListener("touchstart", this.stopProgress.bind(this));
        this.element.addEventListener("touchend", this.startProgress.bind(this));
        this.element.addEventListener("mousedown", this.stopProgress.bind(this));
        this.element.addEventListener("mouseup", this.startProgress.bind(this));
    }
    addProgress() {
        this.container.className = "show";
        this.progressing = window.setInterval(syncProgress, 20);
    }
    stopProgress() {
...
fileElement.addEventListener("change", progress.addProgress);
